...
public class IglooUtilPlugin {
	...
	*/
	...
	public void addUser(Request req, Response resp){
		Map<String, String> user_map = (Map<String, String>) req.get("value");
		UserInfo user = new UserInfo();
		user.setEmail(user_map.get("email"));
		user.setName(user_map.get("name"));
		user.setId(user_map.get("id"));
		user.setIp(user_map.get("ip"));
		resp.put("result", util.addUser(user));
	}
	...
	@MsgbusMethod
	public void userMac(Request req, Response resp){
		String value = req.getString("value");
		resp.put("result", util.userMac(value));
	}
	...
	@MsgbusMethod
	public void removeUserPCInfo(Request req, Response resp){
		Map<String, String> user_map = (Map<String, String>) req.get("value");
		UserInfo user = new UserInfo();
		user.setIp(user_map.get("ip"));
		user.setMac(user_map.get("mac"));
		
		resp.put("result", util.removeUserPCInfo(user));
	}
}
